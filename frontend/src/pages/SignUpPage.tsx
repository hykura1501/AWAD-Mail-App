                  ...
                  <GoogleLogin
                    ...
                    render={({ onClick, disabled }) => (
                      <button
                        onClick={onClick}
                        disabled={disabled}
                        className="relative bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-6 rounded-lg border border-gray-300 shadow-sm transition-all duration-200 flex items-center gap-3 min-w-[280px] justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                      >
